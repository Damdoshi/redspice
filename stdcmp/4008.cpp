...
bool			hbs::CMP_4008::TypeMatches(const std::string	&type)
{
  if (type == "4008")
    return (true);
  if (type == "7483")
...
hbs::IComponent	*hbs::CMP_4008::Create(hbs::Timer		&timer,
...
std::string		hbs::CMP_4008::GetDisplayType(void) const
{
  return ("4008/7483/74283 4-bit full adder");
}
